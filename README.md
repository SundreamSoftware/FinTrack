...
The desktop and mobile dashboard screenshots are generated by the Playwright demo scenario and published as the `screenshots` artifact on each CI run. They contain fictional data only.
